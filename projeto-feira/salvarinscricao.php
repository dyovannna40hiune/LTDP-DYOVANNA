<?php
	...
	$comandosql = "SELECT  quantidade_de_vagas FROM tb_centro_interesse WHERE id_centro_interesse = ".$opcao1;
	...
	$qtdevagas1 = $itembancodados['quantidade_de_vagas'];
	...
	$comandosql = "SELECT  quantidade_de_vagas FROM tb_centro_interesse WHERE id_centro_interesse = ".$opcao2;
	$resultado = mysql_query($comandosql);
	...
	$itembancodados = mysql_fetch_array($resultado);
	$qtdevagas2 = $itembancodados['quantidade_de_vagas'];
